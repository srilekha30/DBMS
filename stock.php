...
if(isset($_POST['submit'])){
	...
	$cost=$_POST['cost'];
	$sta="Available";
	$sql=mysqli_query($con,"INSERT INTO stock(drug_name,category,description,company,supplier,quantity,cost,status)
	VALUES('$sname','$cat','$des','$com','$sup','$qua','$cost','$sta')");
	if($sql>0) {
...
<hr/>	
    <div class="tabbed_area">  
		...
		<?php
		include_once('connect_db.php');
		$result = mysqli_query($con,"SELECT * FROM stock") or die(mysqli_error());
		...
		while($row = mysqli_fetch_array( $result )) {
				...
				<td><a href="delete_stock.php?stock_id=<?php echo $row['stock_id']?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
				<?php
		} 
        echo "</table>";
?> 
        ...
        <div id="content_2" class="content">  
         <?php echo $message;
			...
			<table width="420" height="106" border="0" >	
				...
				<tr><td align="center"><input name="submit" type="submit" value="Submit" id="submit" class="btn btn-success" /></td></tr>
            </table>
		</form>
        </div>  
