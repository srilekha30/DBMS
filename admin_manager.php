...
if(isset($_POST['submit'])){
	...
	if($result>0){
		...
		$sql=mysqli_query($con,"INSERT INTO manager(first_name,last_name,staff_id,postal_address,phone,email,username,password)
...
<hr/>	
    <div class="tabbed_area">  
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_manager.php?username=<?php echo $row['username']?>"><button type="button" class="btn btn-success">Update</button></a></td>
				<td><a href="delete_manager.php?manager_id=<?php echo $row['manager_id']?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
				<?php
		 } 
		 echo "</table>";
?> 
