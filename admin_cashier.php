...
if(isset($_POST['submit'])){
	...
	if($result>0){
		...
		$sql=mysqli_query($con,"INSERT INTO cashier(first_name,last_name,staff_id,postal_address,phone,email,username,password)
...
<html>
<head>
<title><?php echo $username;?> -Admin pharmacy System</title>
...
<hr/>	
    <div class="tabbed_area">  
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_cashier.php?username=<?php echo $row['username']?>"><button type="button" class="btn btn-success">Update</button></a></td>
				<td><a href="delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
				<?php
		}
		echo "</table>";
?> 
		...
		<form name="form1"  onsubmit="return validateForm(validation_script.js);" action="admin_cashier.php" method="post" >
			<table width="220" height="106" border="0" >
				...
				<tr><td align="center"><input name="submit" type="submit" class="btn btn-success" value="Submit"></td></tr>
            </table>
		</form>
        </div>   
    </div>  
