...
if(isset($_POST['submit'])){
	...
	$pas=$_POST['password'];
	$user=$_POST['user'];
	$sql=mysqli_query($con,"UPDATE manager SET first_name='$fname', last_name='$lname', staff_id='$sid',postal_address='$postal',phone='$phone',email='$email',username='$username', password='$pas' WHERE username='$username'");
	if($sql>0) {
    ...
    <div class="tabbed_area">  
       ...
       <form name="myform" onsubmit="return validateForm(this);" action="update_cashier.php" method="post" >
			<table width="420" height="106" border="0" >	
				...
				<tr><td align="center"><input name="submit" type="submit" value="Update" class="btn btn-success" /></td></tr>
            </table>
		</form>
		</div>  
    </div>  
